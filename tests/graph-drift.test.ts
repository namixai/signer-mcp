...
describe("перенесённые модули не разошлись с источником истины", () => {
  ...
  // смотрит. Если положить такую рядом, сторож покраснеет с «в источнике нет фикстуры» —
  // и будет прав: он не знает, что это не копия. Не ослабляй его, положи в подкаталог.
